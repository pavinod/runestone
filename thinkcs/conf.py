...
project = u'<Digital World 2016>' # e.g. How To Think Like a Computer Scientist
copyright = u'<2013, Brad Miller,David Ranum, Oka and Pavithren>' # e.g. "2013, Brad Miller and David Ranum"
...
html_theme_options = {
    ...
    'navbar_title': "<How to think like a computer scientist-Digital World 2016>",
...
html_title = '<How to think like a computer scientist-Digital World 2016>'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='<Digital World 2016>'
